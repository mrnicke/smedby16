...
export default function BlockEditor({ template, blocks, onChange, media = [] }: { template: keyof typeof pageTemplateRules; blocks: ContentBlock[]; onChange: (blocks: ContentBlock[]) => void; media?: EditorMediaAsset[] }) {
  ...
  return <div className="block-editor">
    <div className="block-editor-list">
      <div className="block-editor-heading"><div><p className="eyebrow">Det besökaren ser</p><h2>Sidans innehåll</h2><p>Öppna en innehållsdel för att ändra den. Ordningen här är samma som på webbplatsen.</p></div><span>{blocks.length} innehållsdelar</span></div>
